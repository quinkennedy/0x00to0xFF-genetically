...
public class DNAConverter{
	private int[] m_narrNucleotideToChunk;
	private ArrayList<ArrayList<Integer>> m_narrChunkToNucleotides;
	private int m_nNucleotidesPerChunk;
	
	public DNAConverter(int a_nNumberChunks){
		//m_bIAmRoot = true;
		//m_nNumberChunks = a_nNumberChunks;
		m_nNucleotidesPerChunk = (int)Math.ceil(Math.log(a_nNumberChunks)/Math.log(4));
...
//			System.out.println(i+") nucleotide:"+narrAssignments[i]+" chunk:"+nCurrChunk);
	...
	public Nucleotide[] ConvertSequence(int[] a_narrSequence){
...
//		System.out.println();
	...
	public int[] ConvertSequence(Nucleotide[] a_arrSequence){
//		System.out.print("sequence in:");
